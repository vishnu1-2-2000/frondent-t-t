...
function UserAuditReport() {
                    ...
                    const getUserreport = (e) => {
                                  ...
                                  // fullWidth
                                        ...
                                        id="outlined-Company Prefix"
                                        label={<h4 ><pre><h4 style={{color:"white"}}><font face="times new roman" size="6">                          User Audit Report </font></h4></pre></h4>}
                                  ...
                                  var shippingheadwidget=
                                    ...
                                    ><Controls.Input 
                                      ...
                                      // fullWidth
                                            ...
                                            id="outlined-Company Prefix"
                                            label={<h4 ><pre><h4 style={{color:"white"}}>User Audit Report </h4></pre></h4>}
                                    ...
                                    <div class="container" id="company">
                                     ...
                                     >
                                       ...
                                       <div id="auditreporthead">
                                              ...
                                              <br></br>
                                              <br></br>
                                              <button onClick={getUserreport} className="btn btn-success">                                              
                                             User Audit Report</button>
                                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
