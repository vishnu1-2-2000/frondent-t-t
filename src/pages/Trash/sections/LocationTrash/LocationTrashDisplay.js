...
const LocationTrashDisplay= (props) => {
  ...
  let userDataColumns = [
                        ...
                        renderCell: (params) => {
                          ...
                          //     );
                            ...
                            if (confirmBox === true) {
                              ...
                              axios
                              .delete(window.url+`/master/locations/restore/trash/${thisRow.id}`,
                              {
                                data: { 
                                    "name":thisRow.name, 
                                    "email" : thisRow.email,
                      ...
                      {                             
                          ...
                          headerClassName: "MuiDataGrid-columnHeaders",
                              ...
                              if (confirmBox === true) {
                                    axios
                                    .delete(window.url+`/master/locations/delete/${thisRow.id}`,
                                    {
                                    data: { 
                                      "id":thisRow.id,
                                      "name" : thisRow.name,
...
function getData() {
             ...
             <Sidebar/>
              ...
              <Box component="main" sx={{ flexGrow: 2, p: 7 }}>
...
export default LocationTrashDisplay