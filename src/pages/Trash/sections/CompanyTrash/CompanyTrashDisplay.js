...
const CompanyTrashDisplay=(props)=> {
                        ...
                        renderCell: (params) => {
                          ...
                          //     );
                            ...
                            const confirmBox = window.confirm(
                              "Do you want to restore this company?"
                            )
                            if (confirmBox === true) {
                              
                              axios
                              .delete(window.url+`/master/company/restore/trash/${thisRow.id}`,
                              {
                                data: { 
                          ...
                          renderCell: (params) => {
                            ...
                            const api: GridApi = params.api;
                                  const thisRow: Record<string, GridCellValue> = {};
                                    ...
                                    if (confirmBox === true) {
                                          axios
                                          .delete(window.url+`/master/company/delete/${thisRow.id}`,
                                          {
                                                data: { 
                                                  "id":thisRow.id,
                                                  "company_name" : thisRow.company_name,
...
export default CompanyTrashDisplay
