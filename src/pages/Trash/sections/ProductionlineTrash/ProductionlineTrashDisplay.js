...
const ProductionlineTrashDisplay=(props)=> {
  ...
  let userDataColumns = [
    ...
    { field: 'system_name', headerName: 'System Name',minWidth: 200, width: 244, headerClassName: "MuiDataGrid-columnHeaders",},
    { field: 'line', headerName: 'Line', width: 160, headerClassName: "MuiDataGrid-columnHeaders", },
    {
      field: 'restore',
      width: 160,
      headerName: 'Restore',
      ...
      renderCell: (params) => {
        ...
        //     );
          ...
          if (confirmBox === true) {
            ...
            axios
            .delete(window.url+`/productionline/registeredsystem/restore/trash/${thisRow.id}`,
            {
              data: { 
                "line" : thisRow.line,
                "email" : thisRow.email,
    ...
    {                             
      ...
      renderCell: (params) => {
        const onClick = (e) => {
          ...
          if (confirmBox === true) {
            axios
            .delete(window.url+`/productionline/registeredsystem/delete/${thisRow.id}`,
              {
                data: { 
                  "id":thisRow.id,
                  "Name" : thisRow.name,
  ...
  function createRows(rowDatas) {
    ...
    rowDatas.map(rowData => {
      if(rowData.productionlineflag===true){
      axios
...
export default ProductionlineTrashDisplay
