...
if (confirmBox === true) {
axios
.delete(`http://127.0.0.1:8000/master/master/printer/delete/${thisRow.id}`,
{
//                 data: { 
...
rowDatas.map(rowData => {   
  ...
  temparray.push({
    ...
    //'processordernumber':res2.data[0].processordernumber,
    'gtin':rowData.gtin,
...
function handleDelete(id) {
  axios
    .delete(`http://localhost:8000//master/printer/${id}`,
      {
        // auth: {
        //   username: username,
        //   password: password
