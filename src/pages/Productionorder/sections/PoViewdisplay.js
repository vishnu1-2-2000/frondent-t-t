...
//   <Select className="s" options={products} onChange={getProductasoptions} value={{label:productnamelabel,value:productnamevalue}}/>
  ...
  <TextField required
                    ...
                    id="outline-manufacturinglocation"
                    value={manufactnamelabel}
                    onChange={(e) => setBatch(e.target.value)}
                    /> 
...
// }
    return(
              ...
              <div className="col-3"></div>
                        ...
                        <h4 ><h4 style={{color:"black"}}><font face="times new roman" size="6"> View Productionorder  Data</font></h4></h4><br/>                 
                ...
                <Box
                  component="form"
                  sx={{
                    '& .MuiTextField-root': { m: 3, width: '10' },
                  }}
                  noValidate
                  autoComplete="off"
                >
