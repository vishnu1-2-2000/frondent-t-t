                        ...
                        res.data.forEach(element=>{
                            if(element['activity_name'] === 'product') {
                                ...
                                if(window.localStorage.getItem('loggedInUserrole') === "admin") {
                                    ...
                                    element.admin['UPDATE']==="Checked" ? setSelectedDIV_state(<ProductPropertyEdit/>) :setSelectedDIV_state(notAuthorizedSection);
                                  
                                }
                                else if(window.localStorage.getItem('loggedInUserrole') === "operator") {
                                    
                                    element.operator['UPDATE']==="Checked" ? setSelectedDIV_state(<ProductPropertyEdit/>) :setSelectedDIV_state(notAuthorizedSection);
                                
                                }
                                else if(window.localStorage.getItem('loggedInUserrole') === "supervisor") {
                               
                                    element.supervisor['UPDATE']==="Checked" ? setSelectedDIV_state(<ProductPropertyEdit/>) :setSelectedDIV_state(notAuthorizedSection);   
                                
                                }
                                else if(window.localStorage.getItem('loggedInUserrole')==="masterdata")
                                {
                                   
                                    element.masterdata['UPDATE']==="Checked" ? setSelectedDIV_state(<ProductPropertyEdit/>) :setSelectedDIV_state(notAuthorizedSection);
...
export default ProductPropertyAfterLogin
